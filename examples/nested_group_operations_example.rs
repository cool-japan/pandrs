...
fn main() -> Result<()> {
    ...
    println!("     • Total groups after filtering: {}", filtered_stats.total_groups);
    println!("     • Leaf groups after filtering: {}", filtered_stats.leaf_groups);
    println!("     • Groups per level: {:?}", filtered_stats.groups_per_level);
    ...
    println!("   • Created large dataset with {} rows", large_df.row_count());
...
fn create_business_dataset() -> Result<DataFrame> {
    ...
    let departments = vec![
        "Electronics", "Electronics", "Electronics", "Electronics", "Clothing", "Clothing", "Clothing", "Clothing",
        "Electronics", "Electronics", "Electronics", "Electronics", "Clothing", "Clothing", "Clothing", "Clothing",
        "Electronics", "Electronics", "Electronics", "Electronics", "Clothing", "Clothing", "Clothing", "Clothing",
        "Electronics", "Electronics", "Electronics", "Electronics", "Clothing", "Clothing", "Clothing", "Clothing"
    ];
    ...
    let products = vec![
        "Laptop", "Laptop", "Phone", "Phone", "Shirt", "Shirt", "Pants", "Pants",
        "Laptop", "Laptop", "Phone", "Phone", "Shirt", "Shirt", "Pants", "Pants",
        "Laptop", "Laptop", "Phone", "Phone", "Shirt", "Shirt", "Pants", "Pants",
        "Laptop", "Laptop", "Phone", "Phone", "Shirt", "Shirt", "Pants", "Pants"
    ];
    ...
    let sales = vec![
        25000.0, 28000.0, 15000.0, 16500.0, 2000.0, 2200.0, 1500.0, 1650.0,
        22000.0, 25000.0, 13000.0, 14500.0, 1800.0, 2000.0, 1300.0, 1450.0,
        30000.0, 33000.0, 18000.0, 19500.0, 2400.0, 2600.0, 1800.0, 2000.0,
        27000.0, 30000.0, 16000.0, 17500.0, 2100.0, 2300.0, 1600.0, 1750.0
    ];
    
    let quantities = [
        100, 110, 150, 165, 80, 88, 75, 83,
        90, 100, 130, 145, 72, 80, 65, 73,
        120, 132, 180, 195, 96, 104, 90, 100,
        108, 120, 160, 175, 84, 92, 80, 88
    ];
    ...
    df.add_column("quarter".to_string(), Series::new(
...
fn create_large_business_dataset(multiplier: usize) -> Result<DataFrame> {
    ...
    // Add columns
    large_df.add_column("region".to_string(), Series::new(regions, Some("region".to_string()))?)?;
    large_df.add_column("department".to_string(), Series::new(departments, Some("department".to_string()))?)?;
    large_df.add_column("product".to_string(), Series::new(products, Some("product".to_string()))?)?;
    large_df.add_column("quarter".to_string(), Series::new(quarters, Some("quarter".to_string()))?)?;
    large_df.add_column("sales".to_string(), Series::new(sales, Some("sales".to_string()))?)?;
    large_df.add_column("quantity".to_string(), Series::new(quantities, Some("quantity".to_string()))?)?;
