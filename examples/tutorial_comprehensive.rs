...
fn tutorial_step_1_data_creation() -> Result<(), Box<dyn std::error::Error>> {
    ...
    sales_df.add_string_column("product", vec![
        "Laptop".to_string(),
        "Phone".to_string(), 
        "Tablet".to_string(),
        "Monitor".to_string(),
    ...
    sales_df.add_string_column("category", vec![
    ...
    sales_df.add_string_column("region", vec![
        "North".to_string(),
        "South".to_string(),
        "East".to_string(),
        "West".to_string(),
    ...
    println!("DataFrame created with {} rows and {} columns", 
             sales_df.row_count(), sales_df.column_count());
...
fn tutorial_step_2_data_cleaning() -> Result<(), Box<dyn std::error::Error>> {
    ...
    df.add_string_column("customer_name", vec![
        "John Doe".to_string(),
...
fn tutorial_step_3_transformation() -> Result<(), Box<dyn std::error::Error>> {
    ...
    df.add_float_column("sales", vec![1000.0, 1200.0, 1100.0, 1400.0, 1350.0, 1500.0])?;
...
fn tutorial_step_5_grouping() -> Result<(), Box<dyn std::error::Error>> {
    ...
    df.add_string_column("region", vec![
        "North".to_string(), "North".to_string(), "South".to_string(),
        "South".to_string(), "East".to_string(), "East".to_string(),
        "West".to_string(), "West".to_string(),
    ])?;
    
    df.add_string_column("category", vec![
        "Electronics".to_string(), "Accessories".to_string(), "Electronics".to_string(),
        "Accessories".to_string(), "Electronics".to_string(), "Accessories".to_string(),
        "Electronics".to_string(), "Accessories".to_string(),
    ])?;
    
    df.add_float_column("sales", vec![1000.0, 300.0, 1200.0, 350.0, 800.0, 250.0, 900.0, 280.0])?;
...
fn tutorial_step_6_persistence() -> Result<(), Box<dyn std::error::Error>> {
    ...
    df.add_string_column("metric", vec![
