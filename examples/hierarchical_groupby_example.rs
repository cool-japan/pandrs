...
fn main() -> Result<()> {
    ...
    let mut electronics_groups = df.hierarchical_groupby(vec![
        "region".to_string(),
        "department".to_string()
    ])?;
    ...
    let custom_agg = HierarchicalAggBuilder::new("sales".to_string())
        .at_level(0, AggFunc::Custom, "sales_coefficient_of_variation".to_string())
    ...
    let comprehensive_result = comprehensive_gb.level(0).agg_hierarchical(comprehensive_aggs)?;
    ...
    println!("   • Large dataset stats: {} total groups, {} leaf groups", 
...
fn create_sales_dataset() -> Result<DataFrame> {
    ...
    let products = vec![
        "Laptop", "Phone", "Shirt", "Pants", "Chair", "Table",
        "Laptop", "Phone", "Shirt", "Pants", "Chair", "Table",
        "Laptop", "Phone", "Shirt", "Pants", "Chair", "Table",
        "Laptop", "Phone", "Shirt", "Pants", "Chair", "Table"
    ];
    ...
    let sales = [
        15000.0, 8000.0, 1200.0, 800.0, 2500.0, 3500.0,
        12000.0, 7500.0, 1100.0, 750.0, 2200.0, 3200.0,
        18000.0, 9500.0, 1350.0, 950.0, 2800.0, 4000.0,
        14000.0, 8200.0, 1250.0, 850.0, 2600.0, 3700.0
    ];
