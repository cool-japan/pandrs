...
fn main() -> Result<()> {
    ...
    let prices = [100.0, 102.5, 101.8, 103.2, 104.1, 102.9, 105.6, 107.2, 106.8, 108.1, 109.3, 107.9];
    let volumes = [1000, 1500, 1200, 1800, 2200, 1600, 2400, 2100, 1900, 2300, 2000, 1700];
    let returns = [0.0, 0.025, -0.007, 0.014, 0.009, -0.012, 0.026, 0.015, -0.004, 0.012, 0.011, -0.013];
