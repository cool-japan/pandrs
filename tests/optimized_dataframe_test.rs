...
fn test_optimized_dataframe_rename_columns() {
    ...
    df.add_string_column("old_col2", vec!["a".to_string(), "b".to_string(), "c".to_string()]).unwrap();
    df.add_float_column("old_col3", vec![1.0, 2.0, 3.0]).unwrap();
...
fn test_optimized_dataframe_rename_columns_errors() {
    ...
    df.add_string_column("col2", vec!["a".to_string(), "b".to_string(), "c".to_string()]).unwrap();
...
fn test_optimized_dataframe_set_column_names() {
    ...
    let new_names = vec!["final_col1".to_string(), "final_col2".to_string(), "final_col3".to_string()];
