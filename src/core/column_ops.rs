...
pub trait ColumnOps<T> {
    ...
    fn eq(&self, other: &Self) -> std::result::Result<BooleanColumn, Self::Error> where T: PartialEq;
    fn ne(&self, other: &Self) -> std::result::Result<BooleanColumn, Self::Error> where T: PartialEq;
    fn lt(&self, other: &Self) -> std::result::Result<BooleanColumn, Self::Error> where T: PartialOrd;
    fn le(&self, other: &Self) -> std::result::Result<BooleanColumn, Self::Error> where T: PartialOrd;
    fn gt(&self, other: &Self) -> std::result::Result<BooleanColumn, Self::Error> where T: PartialOrd;
    fn ge(&self, other: &Self) -> std::result::Result<BooleanColumn, Self::Error> where T: PartialOrd;
    
    // Unique and duplicates
    fn unique(&self) -> std::result::Result<Self::Output, Self::Error> where T: Eq + std::hash::Hash;
    fn nunique(&self) -> usize where T: Eq + std::hash::Hash;
    fn is_unique(&self) -> bool where T: Eq + std::hash::Hash;
    fn duplicated(&self, keep: DuplicateKeep) -> std::result::Result<BooleanColumn, Self::Error> where T: Eq + std::hash::Hash;
    
    // Sorting
    fn sort(&self, ascending: bool) -> std::result::Result<Self::Output, Self::Error> where T: Ord;
    fn argsort(&self, ascending: bool) -> std::result::Result<Vec<usize>, Self::Error> where T: Ord;
    ...
    T: num_traits::Num + Copy + PartialOrd + Send + Sync + 'static
{
    ...
    fn round(&self, decimals: i32) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
    fn floor(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
    fn ceil(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
    
    // Mathematical functions
    fn abs(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Signed;
    fn sqrt(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
    fn exp(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
    fn log(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
    fn sin(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
    fn cos(&self) -> std::result::Result<Self::Output, Self::Error> where T: num_traits::Float;
}
...
pub trait StringColumnOps: ColumnOps<String> {
    ...
    // Pattern matching
    fn contains(&self, pattern: &str, regex: bool) -> std::result::Result<BooleanColumn, Self::Error>;
    ...
    fn replace(&self, pattern: &str, replacement: &str, regex: bool) -> std::result::Result<Self::Output, Self::Error>;
    fn slice_str(&self, start: Option<usize>, end: Option<usize>) -> std::result::Result<Self::Output, Self::Error>;
    ...
    fn pad(&self, width: usize, side: PadSide, fillchar: char) -> std::result::Result<Self::Output, Self::Error>;
    fn center(&self, width: usize, fillchar: char) -> std::result::Result<Self::Output, Self::Error>;
    fn ljust(&self, width: usize, fillchar: char) -> std::result::Result<Self::Output, Self::Error>;
    fn rjust(&self, width: usize, fillchar: char) -> std::result::Result<Self::Output, Self::Error>;
}
...
pub trait DateTimeColumnOps: ColumnOps<chrono::DateTime<chrono::Utc>> {
    ...
    fn between(&self, start: &chrono::DateTime<chrono::Utc>, end: &chrono::DateTime<chrono::Utc>) -> std::result::Result<BooleanColumn, Self::Error>;
    ...
    T: Clone + Eq + std::hash::Hash + Send + Sync + 'static
{
    ...
    /// Set categories
    fn set_categories(&mut self, categories: Vec<T>, ordered: bool) -> std::result::Result<(), Self::Error>;
    ...
    /// Reorder categories
    fn reorder_categories(&mut self, new_categories: Vec<T>) -> std::result::Result<(), Self::Error>;
...
pub trait ColumnStorage {
    ...
    fn allocate(&mut self, capacity: usize) -> std::result::Result<Self::StorageType, Box<dyn std::error::Error>>;
    fn deallocate(&mut self, storage: Self::StorageType);
    fn resize(&mut self, storage: &mut Self::StorageType, new_size: usize) -> std::result::Result<(), Box<dyn std::error::Error>>;
    fn memory_usage(&self) -> usize;
}
...
pub trait TypedColumn<T>: ColumnOps<T> {
    ...
    fn into_vec(self) -> Vec<T> where Self: Sized;
    fn from_vec(data: Vec<T>, name: Option<String>) -> Self where Self: Sized;
}
...
pub trait ColumnCast<T, U> {
    ...
    fn safe_cast(&self, errors: CastErrorBehavior) -> std::result::Result<Box<dyn std::any::Any>, Self::Error>;
}
...
pub trait ColumnFactory {
    ...
    fn create_datetime(&self, data: Vec<chrono::DateTime<chrono::Utc>>, name: Option<String>) -> DateTimeColumn;
    fn create_categorical<T>(&self, data: Vec<T>, categories: Vec<T>, name: Option<String>) -> CategoricalColumn
    where
...
impl ColumnFactory for DefaultColumnFactory {
    ...
    fn create_datetime(&self, _data: Vec<chrono::DateTime<chrono::Utc>>, _name: Option<String>) -> DateTimeColumn {
        unimplemented!("DateTimeColumn creation not yet implemented")
    }
    
    fn create_categorical<T>(&self, _data: Vec<T>, _categories: Vec<T>, _name: Option<String>) -> CategoricalColumn
    where
        T: Clone + Eq + std::hash::Hash + Send + Sync + 'static + Into<String>
    {
