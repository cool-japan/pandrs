...
use crate::column::{Float64Column, Int64Column, ColumnTrait};
...
impl SIMDColumnArithmetic {
    ...
    pub fn add_columns(
        ...
        match (left, right) {
            (Column::Float64(l), Column::Float64(r)) => {
                Ok(Column::Float64(l.simd_add(r)?))
            },
            (Column::Int64(l), Column::Int64(r)) => {
                Ok(Column::Int64(l.simd_add(r)?))
            },
    ...
    pub fn multiply_columns(
        ...
        match (left, right) {
            (Column::Float64(l), Column::Float64(r)) => {
                Ok(Column::Float64(l.simd_multiply(r)?))
            },
            (Column::Int64(l), Column::Int64(r)) => {
                Ok(Column::Int64(l.simd_multiply(r)?))
            },
            (Column::Float64(l), Column::Int64(r)) => {
                let r_float = r.to_float64_simd()?;
    ...
    pub fn multiply_scalar(
        ...
        match column {
            Column::Float64(col) => {
                Ok(Column::Float64(col.simd_multiply_scalar(scalar)?))
            },
            Column::Int64(col) => {
